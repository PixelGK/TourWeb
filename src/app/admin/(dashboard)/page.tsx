...
const metrics = [
  ...
  { key: "pendingPayments", label: "Pending payment", icon: Clock3, format: (value: number) => String(value) },
...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-10">
      <AdminPageHeader eyebrow="01 · Dispatch" title="Today at a glance" description="A compact operating view: money confirmed, guests waiting, and the dates that need attention." />
