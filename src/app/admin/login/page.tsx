    ...
    <main className="grid min-h-screen bg-limestone lg:grid-cols-[1.15fr_0.85fr]">
      <section className="relative hidden overflow-hidden bg-charcoal p-12 text-frangipani lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-xl">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-gold">Operator’s field desk</p>
          <h1 className="mt-5 font-serif text-6xl leading-[0.95]">The island moves.<br />Keep the day clear.</h1>
          <p className="mt-6 max-w-md text-lg leading-8 text-frangipani/65">Bookings, guest details, routes, and capacity in one focused workspace built for one hands-on operator.</p>
        </div>
      ...
      <section className="flex items-center justify-center px-4 py-14 sm:px-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-clay">Private workspace</p>
          <h2 className="mt-2 font-serif text-4xl">Welcome back.</h2>
          <p className="mb-7 mt-3 text-weathered">Sign in with the owner account stored in the database.</p>
