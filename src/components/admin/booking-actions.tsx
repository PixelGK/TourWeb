  ...
  return (
    <div className="space-y-2 text-right">
      <div className="flex justify-end gap-2">
        ...
        {status === "PAID" && !confirmed ? <form action={action}><input type="hidden" name="id" value={id} /><input type="hidden" name="action" value="confirm" /><Button type="submit" size="sm" variant="ghost" disabled={preview || pending} className="text-success"><Check className="size-3.5" aria-hidden="true" /> Confirm</Button></form> : null}
