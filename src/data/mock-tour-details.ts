...
const tourContentOverrides: Record<string, TourContentOverride> = {
  "ancient-bali-tampaksiring": {
    ...
    exclusions: ["Estimated admission budget: IDR 150k–200k per adult, paid locally", "Licensed site or temple guide", "Meals and personal purchases", "Purification offering or change of clothes", "Personal travel insurance"],
  ...
  "penglipuran-besakih-cultural-route": {
    ...
    exclusions: ["Estimated admission budget: IDR 110k–150k per adult, paid locally", "Official or local guide fees beyond the current ticket inclusion", "Meals and personal purchases", "Ceremonial donations", "Personal travel insurance"],
  ...
  "jatiluwih-bedugul-water-temples": {
    ...
    inclusions: ["Private air-conditioned vehicle for up to 6 guests", "Experienced English-speaking local driver", "Hotel pickup and drop-off", "Fuel and parking", "Route planning", "Drinking water"],
    exclusions: ["Estimated admission budget: IDR 200k–275k per adult, paid locally", "Licensed site guide", "Meals and personal purchases", "Rain gear", "Personal travel insurance"],
    pricingTiers: [{ minPax: 1, maxPax: 6, perPersonIdr: 950000 }],
  ...
  "sidemen-weaving-besakih": {
    ...
    exclusions: ["Estimated admission budget: IDR 60k–100k per adult, paid locally", "Village or workshop donations where requested", "Meals and personal purchases", "Textile purchases", "Personal travel insurance"],
    pricingTiers: [{ minPax: 1, maxPax: 6, perPersonIdr: 950000 }],
  ...
  "taman-ayun-tanah-lot-sunset": {
    ...
    exclusions: ["Estimated admission budget: IDR 150k–175k per adult, paid locally", "Licensed temple guide", "Meals and drinks", "Personal purchases", "Personal travel insurance"],
    pricingTiers: [{ minPax: 1, maxPax: 6, perPersonIdr: 750000 }],
...
export function getTourDetail(tour: MockTour): MockTourDetail {
  ...
  return {
    ...
    pricingTiers: contentOverride?.pricingTiers ?? (tour.pricingMode === "PER_VEHICLE" ? [{ minPax: 1, maxPax: 6, perPersonIdr: tour.priceIdr }] : buildPricing(tour.priceIdr)),
